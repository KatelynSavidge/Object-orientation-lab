...
favoriteThings.show = 'jujustu kaisen'

/*
  Now use bracket or dot notation to change the value of the food key in your favoriteThings object to be 'Chicken Nuggets'
  and change the value of the book key in your favoriteThings object to be 'Harry Potter'. (If they were either of those things 
    already, change them to something else.)
*/
...
//A function that takes in an object named "input".
function totalPopulation(input) {
  
  //Use object destructing to save the values to new variables.
  let {utah, california, texas, arizona} = input
...
//This is an object named population with 4 properties 
//named utah, california, texas, and arizona.
let population = {
  utah: 1000000,
  california: 2000000,
  texas: 3000000,
...
//////////////////////////// PROBLEM 12 ////////////////////////////
/*
  Create a class called 'Cat'. Make sure to call your constructor, and require these 3 parameters: name, age, 
  color.
...
let milo = new Cat('milo', 10, 'orange')
...
let kat = new wizard ('kat', 22, 'disappear')
